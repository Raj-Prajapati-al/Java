			...
			<div class="row align-items-center justify-content-between">
				...
				<div class="col-lg-6 col-sm-6">
					<div class="single_feature_post_text">
						...
						<form method="post" action="viewsubservice.jsp">
							<button type="submit" name="serviceid" value="<%=rs.getInt(1)%>"
								class="feature_btn">
								EXPLORE NOW <i class="fas fa-play"></i>
							</button>
						</form>
						<img src="img/product/<%=rs.getString(3)%>" alt="" width="300px"
							height="200px" style="border-radius: 5px;">
					</div>
				</div>
				<%
				}
