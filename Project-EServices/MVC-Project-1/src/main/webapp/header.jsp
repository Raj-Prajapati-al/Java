							...
							<ul class="navbar-nav">
								...
								<c:if test="${not empty firstname}">
									<li class="nav-item"><a class="nav-link"
										href="cust-home.jsp">Home</a></li>
									<li class="nav-item"><a class="nav-link"
										href="cust-home.jsp"> Services </a></li>
								</c:if>
								...
								<c:if test="${empty firstname}">
									<li class="nav-item dropdown"><a
										...
										<div class="dropdown-menu" aria-labelledby="navbarDropdown_2">
											<a class="dropdown-item" href="cust-signup.jsp">Sign Up</a> <a
												class="dropdown-item" href="cust-login.jsp">Login</a>
										</div></li>
								</c:if>
								...
								<%
								if (session.getAttribute("model") != null && !session.getAttribute("model").toString().isEmpty()) {
								%>
								<li class="nav-item dropdown"><a
									class="nav-link dropdown-toggle" id="navbarDropdown_3"
									role="button" data-toggle="dropdown" aria-haspopup="true"
									aria-expanded="false">Welcome, <%=session.getAttribute("firstname")%></a>
									<div class="dropdown-menu" aria-labelledby="navbarDropdown_3">
										<a class="dropdown-item" href="profile.jsp">Profile</a> <a
											class="dropdown-item" href="LogoutServlet">Log out</a>
									</div></li>
								<%
								}
								%>
