			...
			<div class="row align-items-center justify-content-between">
				...
				<div class="col-lg-6 col-sm-6">
					<div class="single_feature_post_text">
						<p><%=rs.getString(4)%></p>
						<h3><%=rs.getString(3)%>(Rs :
							<%=rs.getString(5)%>)
						</h3>
						<a
							href="book.jsp?subserviceid=<%=rs.getInt(1)%>&price=<%=rs.getString(5)%>"
							class="feature_btn">Book Services <i class="fas fa-play"></i></a>
						<img src="productimages/<%=rs.getString(3)%>" alt="">
					</div>
				</div>
