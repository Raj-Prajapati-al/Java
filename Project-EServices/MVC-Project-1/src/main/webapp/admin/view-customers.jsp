							...
							<c:forEach var="customer" items="${customerList}">
								<tr>
									...
									<td class="action-links"><a
										href="edit-customer.jsp?id=${customer.customerid}"
										class="btn btn-sm btn-warning"> <i
											class="bi bi-pencil-square"></i>Edit
									</a> <a href="delete-customer.jsp?id=${customer.customerid}"
										class="btn btn-sm btn-danger"> <i class="bi bi-trash-fill"></i>Delete
									</a></td>
								</tr>
							</c:forEach>
						</tbody>
