			...
			<div class="main-content">
				...
				<div class="table-responsive mt-4">
					<table
						...
						<tbody>
							<%
							List<AddServiceModel> serviceList = (List<AddServiceModel>) session.getAttribute("serviceList");
							for (AddServiceModel service : serviceList) {
							%>
							<tr>
								<td><span class="badge bg-primary"><%=service.getServiceid()%></span>
								</td>
								<td><%=service.getServicename()%></td>
								<td><img src="../img/product/<%=service.getImage()%>"
									alt="Service Image" class="img-thumbnail"
									style="width: 80px; height: auto;"></td>
								<td><a
									href="editservice.jsp?id=<%=service.getServiceid()%>"
									class="btn btn-sm btn-warning"> <i
										class="bi bi-pencil-square"></i> Edit
								</a> <a href="deleteservice.jsp?id=<%=service.getServiceid()%>"
